      ...
      <div className="main-home-db">
        ...
        {imgs[id - 1].img2 ?
          <div className="images-tab-home">
            <img className="img-home-left" style={{ width: "450px", height: "auto" }} src={imgs[id - 1].img1} />
            <img className="img-home-right" style={{ width: "450px", height: "auto" }} src={imgs[id - 1].img2} />
          </div>
          :
          <div className="images-tab-home">
            <img className="akela-picture-home" style={{ width: "600px", height: "400px" }} src={imgs[id - 1].img1} />
          </div>}
      </div>
    );
  }
