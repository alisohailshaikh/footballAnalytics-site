...
export default function HomeDashboard(id,json1) {
    ...
    <div className="main-home-db">
      <div className="home-stats">
        <div className="home-count">
          {imgs[id.id-1].complete_normal}
          <br></br>
          {imgs[id.id-1].complete_long}
          <br></br>
          {imgs[id.id-1].complete_progressive}
          <br></br>
          {imgs[id.id-1].complete_cutback}
          <br></br>
          {imgs[id.id-1].complete_cross}
        </div>
        <div className="home-somethin">
        {imgs[id.id-1].incomplete_normal}
          <br></br>
          {imgs[id.id-1].incomplete_long}
          <br></br>
          {imgs[id.id-1].incomplete_progressive}
          <br></br>
          {imgs[id.id-1].incomplete_cutback}
          <br></br>
         {imgs[id.id-1].incomplete_cross}
      ...
      <img className="img-home-left" style={{ width: "450px", height: "auto" }} src={imgs[id.id-1].img1} />
      <img className="img-home-right" style={{ width: "450px", height: "auto" }} src={imgs[id.id-1].img2}/>
      </div>
        : 
        <div className="images-tab-home">
        <img className="akela-picture-home" style={{ width: "600px", height: "400px" }} src={imgs[id.id-1].img1} />
        </div> }
      </div>
  );
}
