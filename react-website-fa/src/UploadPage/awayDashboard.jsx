...
setFetchData(true);
  ...
  return (
    <div className="main-away-db">
      ...
      <img className="img-away-left" style={{ width: "450px", height: "auto" }} src={imgs[id.index].img1} />
      <img className="img-away-right" style={{ width: "450px", height: "auto" }} src={imgs[id.index].img2}/>
      </div>
        : 
        <div className="images-tab-away">
        <img className="akela-picture-away" style={{ width: "600px", height: "400px" }} src={imgs[id.index].img1} />
        </div> }
      </div>
  );
}
